...
const App = (props) => {
  return (
    <div>
      <Header title="Let's play the game" />
      <Layout id="1" title="First you need to know some rules" urlBg={bg}>
        <p>
      ...
      <Layout id="2" title="Second - pick up cards" colorBg="green">
        <div className="flex">
          {POKEMONS.map((i) => (
            <PokemonCard
              key={i.id}
      ...
      <Layout id="3" title="And some rules here too))" urlBg={bg}>
        <p>
